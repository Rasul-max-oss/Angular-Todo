...
Простое и красивое приложение для управления задачами, созданное на
Angular с поддержкой темной темы.
...
-   Поиск по задачам (не готово к реализации)
...
1.  Добавление задачи - введите текст в поле ввода и нажмите Enter или
    > кнопку \"+\"

2.  Отметка выполнения - кликните по чекбоксу слева от задачи

3.  Редактирование - нажмите кнопку карандаша на задаче

4.  Удаление - нажмите кнопку корзины на задаче

5.  Смена темы - кликните на иконку луны/солнца в правой части
...
2.  Создайте ветку для вашей функции (git checkout -b
...
Этот проект распространяется под лицензией MIT. Смотрите файл LICENSE
для подробностей.
...
-   GitHub: [@](https://github.com/yourusername)Rasul-max-oss

-   Email: rasul.rzaev.2014@mail.ru
...
-   Вдохновение от [Todoist](https://todoist.com/) и [Microsoft To
    > Do](https://todo.microsoft.com/)
